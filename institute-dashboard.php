            ...
            <div class="container">
                <div class="text-center text-white ">
                    ...
                    <ol class="breadcrumb text-center">
                        ...
                        <li class="breadcrumb-item  text-white">My Dashboard</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="row my-2">
                            ...
                            <div class="card-body p-0">
                                <ul class="vertical-scroll">
                                    ...
                                    <li class="item2">
                                        <div class="footerimg d-flex mt-0 mb-0">
                                            <div class="d-flex footerimg-l mb-0">
                                                <img src="assets/images/faces/male/1.jpg" alt="image"
                                                    class="avatar brround  me-2" loading="lazy">
                                    ...
                                    <li class="item2">
                                        <div class="footerimg d-flex mt-0 mb-0">
                                            <div class="d-flex footerimg-l mb-0">
                                                <img src="assets/images/faces/female/1.jpg" alt="image"
                                                    class="avatar brround  me-2" loading="lazy">
                                                <a href="#" class="time-title p-0 leading-normal mt-2">Barbra Flegle
                    ...
                    <div class="col-lg-4 col-md-4 item-all-cat  ">
                        <div class="item-all-card text-dark text-center card mb-5 bg-dash shadow">
                            <a href="institute-list.php"></a>
                            <div class="iteam-all-icon">
                                <img src="assets/images/icons/institute.svg" class="imag-service" alt="Sales">
                                <h4 class="text-body font-weight-bold mb-2 mt-2">Institute</h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 item-all-cat  ">
                        <div class="item-all-card text-dark text-center card mb-5 bg-dash shadow">
                            <a href="institute-teacher-list.php"></a>
                            <div class="iteam-all-icon">
                                <img src="assets/images/icons/teachers.svg" class="imag-service" alt="Sales">
                                <h4 class="text-body font-weight-bold mb-2 mt-2">Tecaher Managers</h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 item-all-cat  ">
                        <div class="item-all-card text-dark text-center card mb-5 bg-dash shadow">
                            <a href="institute-batchlist.php"></a>
                            <div class="iteam-all-icon">
                                <img src="assets/images/icons/batches.svg" class="imag-service" alt="Sales">
                                <h4 class="text-body font-weight-bold mb-2 mt-2">Batches</h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 item-all-cat  ">
                        <div class="item-all-card text-dark text-center card mb-5 bg-dash shadow">
                            <a href="institute-courselist.php"></a>
                            <div class="iteam-all-icon">
                                <img src="assets/images/icons/course-svgrepo-com (1).svg" class="imag-service" alt="Sales">
                    ...
                    <div class="col-lg-4 col-md-4 item-all-cat  ">
                        <div class="item-all-card text-dark text-center card mb-5 bg-dash shadow">
                            <a href="institute-list.php"></a>
                            <div class="iteam-all-icon">
                                <img src="assets/images/icons/class.svg" class="imag-service" alt="Sales">
                                <h4 class="text-body font-weight-bold mb-2 mt-2">Tution Classes</h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 item-all-cat  ">
                        <div class="item-all-card text-dark text-center card mb-5 bg-dash shadow">
                            <a href="institute-leavelist.php"></a>
                            <div class="iteam-all-icon">
                                <img src="assets/images/icons/leave.svg" class="imag-service" alt="Sales">
                                <h4 class="text-body font-weight-bold mb-2 mt-2"> Leave list
                                </h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 item-all-cat  ">
                        <div class="item-all-card text-dark text-center card mb-5 bg-dash shadow">
                            <a href="institute-msplist.php"></a>
                            <div class="iteam-all-icon">
                    ...
                    <div class="col-lg-4 col-md-4 item-all-cat  ">
                        <div class="item-all-card text-dark text-center card mb-5 bg-dash shadow">
                            <a href="institute-holidaylist.php"></a>
                            <div class="iteam-all-icon">
                                <img src="assets/images/icons/holiday.svg" class="imag-service" alt="Sales">
                                <h4 class="text-body font-weight-bold mb-2 mt-2">Holiday Management</h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 item-all-cat  ">
                        <div class="item-all-card text-dark text-center card mb-5 bg-dash shadow">
                            <a href="institute-attendancelist.php"></a>
                            <div class="iteam-all-icon">
