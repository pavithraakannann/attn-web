                ...
                <nav class="horizontalMenu clearfix d-md-flex">
                    <ul class="horizontalMenu-list">
                        <li aria-haspopup="true"><a href="#"><i class="fa fa-user-circle-o px-1"></i>My Account</a>
                            <ul class="sub-menu">
                                <li aria-haspopup="true"><a href="parent-dashboard.php">My Dashboard</a></li>
                                <li aria-haspopup="true"><a href="parent-editprofile.php">View Profile</a></li>
                                <li aria-haspopup="true"><a href="parent-payments.php">My Payments</a></li>
                                <li aria-haspopup="true"><a href="parent-notification.php">My Notifications</a>
                                </li>
                            </ul>
                        </li>
                        <!-- <li aria-haspopup="true"><a href="parent-courselist.php"><i class="fa fa-th px-1"></i>Courses
                                List</a></li> -->
                        <li aria-haspopup="true"><a href="parent-enrollmentlist.php"><i class="fa fa-id-card-o px-1" ></i>Enrollments</a></li>
                        <li aria-haspopup="true"><a href="parent-attendance.php"><i class="fa fa-book px-1" ></i>Attendance</a></li>
                        <li aria-haspopup="true"><a href="parent-ratings.php"><i class="fa fa-star px-1"></i>
                                Ratings</a>
                        </li>
                        <li aria-haspopup="true"><a href="parent-subscription.php"><i class="fa fa-credit-card"></i>
                            </a></li>
                            ...
                            <div class="panel">
                                <div class="notification-panel" id="notificationPanel">
                                    ...
                                    <p class="text-end"><a href="parent-notification.php" class=" text-primary">See more</a></p>
