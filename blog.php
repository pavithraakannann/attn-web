                ...
                <div id="owl-demo2" class="owl-carousel owl-carousel-icons2">
                    ...
                    <div class="item ">
                        <div class="card card-aside">
                            <div class="card-body ">
                                <div class="card-item d-flex">
                                    <img src="assets/images/products/h1.jpg" alt="img" class="w-8 h-8 br-3">
                                    <div class="ms-4">
                                        <h6 class="font-weight-bold mt-2 mb-3">Duplex House Model</h6>
                                        <a href="blog-detail.php" class="btn btn-primary btn-sm">Read More</a>
                                    </div>
                    ...
                    <div class="item ">
                        <div class="card card-aside">
                            <div class="card-body ">
                                <div class="card-item d-flex">
                                    <img src="assets/images/products/h2.jpg" alt="img" class="w-8 h-8 br-3">
                                    <div class="ms-4">
                                        <h6 class="font-weight-bold mt-2 mb-3">Duplex House Model</h6>
                                        <a href="blog-detail.php" class="btn btn-primary btn-sm">Read More</a>
                                    </div>
                    ...
                    <div class="item ">
                        <div class="card card-aside">
                            <div class="card-body ">
                                <div class="card-item d-flex">
                                    <img src="assets/images/products/h3.jpg" alt="img" class="w-8 h-8 br-3">
                                    <div class="ms-4">
                                        <h6 class="font-weight-bold mt-2 mb-3">Duplex House Model</h6>
                                        <a href="blog-detail.php" class="btn btn-primary btn-sm">Read More</a>
                                    </div>
                    ...
                    <div class="item ">
                        <div class="card card-aside">
                            <div class="card-body ">
                                <div class="card-item d-flex">
                                    <img src="assets/images/products/h4.jpg" alt="img" class="w-8 h-8 br-3">
                                    <div class="ms-4">
                                        <h6 class="font-weight-bold mt-2 mb-3">Duplex House Model</h6>
                                        <a href="blog-detail.php" class="btn btn-primary btn-sm">Read More</a>
                                    </div>
                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-justify">Ut enim ad minima veniam, quis exercitationem into enim ad minima veniam, quis nostrum itationem </p>
                                <a href="blog-detail.php" class="btn btn-primary btn-sm">Read More</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card">
                            <div class="item7-card-img">
                                <a href="blog-detail.php"></a>
                                <img src="assets/images/products/products/b4.jpg" alt="img" class="cover-image">
                            </div>
                            <div class="card-body">
                                <a href="blog-detail.php" class="text-dark">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card">
                            <div class="item7-card-img">
                                <a href="blog-detail.php"></a>
                                <img src="assets/images/products/products/b5.jpg" alt="img" class="cover-image">
                            </div>
                            <div class="card-body">
                                <a href="blog-detail.php" class="text-dark">
