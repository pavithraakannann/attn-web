        ...
        <div class="header-text mb-0">
            <div class="container">
                <div class="text-center text-white ">
                    <h1 class="">Add Holiday </h1>
                    <ol class="breadcrumb text-center">
                        <li class="breadcrumb-item"><a href="institute-dashboard.php">Home</a></li>
                        <li class="breadcrumb-item  text-white">Holiday Form</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="col-xl-9 col-lg-12 col-md-12">
                <div class="card ">
                    <div class="card-header bg-primary ">
                        <h3 class="card-title text-white fs-5 py-1">Holiday Form</h3>
                    </div>
                </div>
                <div class="card mb-0 ">
                    <div class="container">
            ...
            <div class="modal-body">
                ...
                <div class=" mb-0 p-5">
                    ...
                    <div class="submit text-center mt-2">
                        <a href="institute-holidaylist.php" class=" btn btn-secondary px-5 fs-6"><span class="">Okay</span></a>
                    </div>
                </div>
            </div>
        </div>
