                                ...
                                <div class="card">
                                    <ul class="nav nav-tabs justify-content-center bg-primary pers-info" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link active pers-link fs-6 px-5 py-2  text-white" id="tab-11-tab" data-bs-toggle="tab" href="#tab-11" role="tab" aria-controls="tab-11" aria-selected="true">Personal info </a>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link pers-link fs-6 px-5 py-2  text-white" id="tab-12-tab" data-bs-toggle="tab" href="#tab-12" role="tab" aria-controls="tab-12" aria-selected="false"> Address deatils
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="text" class="form-control ps py-5" placeholder="Enter here">
                                                            </div>
                                                            <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="email" class="form-control ps py-5" placeholder="Enter email">
                                                            </div>
                                                            <div class="col-md-6">
                                                    ...
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="phonenumber" class="form-control ps py-5" placeholder=" Phone number">
                                                            </div>
                                                            <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="text" class="form-control ps py-5" placeholder="Enter permanent address">
                                                            </div>
                                                            <div class="col-md-6">
                                                                <label class="form-label text-dark">Address 2</label>
                                                                <input type="text" class="form-control ps py-5" placeholder="Enter additional address">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="text" class="form-control ps py-5" placeholder="Enter city ">
                                                            </div>
                                                            <div class="col-md-6">
                                                                <label class="form-label text-dark">State</label>
                                                                <input type="text" class="form-control ps py-5" placeholder="Enter state">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="text" class="form-control ps py-5" placeholder="Enter country">
                                                            </div>
                                                            <div class="col-md-6">
                                                                <label class="form-label text-dark">Zipcode</label>
                                                                <input type="text" class="form-control ps py-5" placeholder="Enter zipcode">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="form-file">
                                                            <input type="file" class="form-control example-file-input-custom bg-light" name="example-file-input-custom">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="card-footer ">
            ...
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                ...
                <div class=" mb-0 p-5">
                    <div class="text-center m-5">
                        <img src="assets/images/photos/main-1 (2).png" loading="lazy" alt="whovee" width="40" class="">
                    </div>
                    ...
                    <div class="submit text-center mt-2">
                        <a href="hosteller-dashboard.php" class=" btn btn-secondary px-5 fs-6"><span class="">Okay</span></a>
                    </div>
                </div>
