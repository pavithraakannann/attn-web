            ...
            <div class="modal-body">
                ...
                <div class=" mb-0 p-5">
                    ...
                    <div class="submit text-center mt-2">
                        <a href="hostel-edit-profile.php" class=" btn btn-secondary px-5 fs-6"><span
                                class="">Okay</span></a>
                    </div>
                </div>
...
<div class="modal fade " id="otppopup" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-header">
                <h5 class="modal-title" id="exampleCommentLongTitle">Enter the OTP</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                </button>
            </div>
            <div class="modal-body">
...
<div class="modal fade " id="getphonenumber" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content  ">
        <div class="modal-header">
                <h5 class="modal-title" id="exampleCommentLongTitle">Enter new number</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                </button>
            </div>
            <div class="modal-body">
