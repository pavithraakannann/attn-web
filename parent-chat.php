            ...
            <div class="col-xl-9 col-lg-12 col-md-12">
                <div id="chat" class="chat">
                    <div class="conversation">
                        <div class="head">
                            <img src="assets/images/photos/main-1 (2).png" alt="" width="40">
                            <img src="assets/images/brand/hovee_attendance_1.svg" alt="" width="150">
                            <div class="buttons">
                        ...
                        <div class="field">
                            ...
                            <input id="input-message" class="input-message" type="text"
