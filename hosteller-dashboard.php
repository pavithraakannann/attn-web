                    ...
                    <div class="row">
                                            ...
                                            <div class="footerimg d-flex mt-0 mb-0">
                                                ...
                                                <div class="mt-2 footerimg-r ms-auto">
                                                    <a href="#" data-bs-toggle="tooltip" data-bs-placement="top" title
                                                        data-bs-original-title="Articles"><span
                        ...
                        <div class="col-lg-4 col-md-4 item-all-cat  ">
                            <div class="item-all-card text-dark text-center card mb-5 bg-dash shadow">
                                <a href="hosteller-verifications.php"></a>
                        ...
                        <div class="col-lg-4 col-md-4 item-all-cat  ">
                            <div class="item-all-card text-dark text-center card mb-5 bg-dash shadow">
                                <a href="hosteller-attendlist.php"></a>
                                <div class="iteam-all-icon">
                                    <img src="assets/images/media/10.png" class="imag-service" alt="Sales">
                        ...
                        <div class="col-lg-4 col-md-4 item-all-cat  ">
                            <div class="item-all-card text-dark text-center card mb-5 bg-dash shadow">
                                <a href="hosteller-leavelist.php"></a>
                                <div class="iteam-all-icon">
                                    <img src="assets/images/media/5.png" class="imag-service" alt="Sales">
                                    <h4 class="text-body font-weight-bold mb-2 mt-2">Leave
                                    </h4>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 item-all-cat  ">
                            <div class="item-all-card text-dark text-center card mb-5 bg-dash shadow">
                                <a href="hosteller-msplist.php"></a>
                                <div class="iteam-all-icon">
                                    <img src="assets/images/media/11.png" class="imag-service" alt="Sales">
                                    <h4 class="text-body font-weight-bold mb-2 mt-2">MSP</h4>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 item-all-cat  ">
                            <div class="item-all-card text-dark text-center card mb-5 bg-dash shadow">
                                <a href="hosteller-fees.php"></a>
                                <div class="iteam-all-icon">
                                    <img src="assets/images/media/9.png" class="imag-service" alt="Sales">
                                    <h4 class="text-body font-weight-bold mb-2 mt-2">Fees</h4>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 item-all-cat  ">
                            <div class="item-all-card text-dark text-center card mb-5 bg-dash shadow">
                                <a href="hostellerpayments.php"></a>
                                <div class="iteam-all-icon">
                                    <img src="assets/images/media/10.png" class="imag-service" alt="Sales">
