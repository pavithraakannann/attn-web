        ...
        <div class="header-text mb-0">
            <div class="container">
                <div class="text-center text-white ">
                    <h1 class="">Add Tution Class</h1>
                    <ol class="breadcrumb text-center">
                        <li class="breadcrumb-item"><a href="institute-dashboard.php">Home</a></li>
                        <li class="breadcrumb-item  text-white">Tution Class Form</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="col-xl-9 col-lg-12 col-md-12">
                <div class="card ">
                    <div class="card-header bg-primary ">
                        <h3 class="card-title text-white fs-5 py-1">Tution Form</h3>
                    </div>
                </div>
                <div class="card mb-0 ">
                    <div class="container">
                                ...
                                <div class="col-lg-12 col-xl-12 col-md-6 d-block mx-auto kmky ">
                                    <div class="wrapper2 bg-white">
                                        <form action="" method="POST" id="Register" class="card-body" tabindex="500">
                                            ...
                                            <div class="form-group">
                                                <label class="form-label">Batch names</label>
                                                <input type="text" class="form-control " placeholder="Batch name">
                                            </div>
                                            <div class="submit text-end mt-5">
                                                <a href="#" class=" btn btn-secondary px-5" data-bs-toggle="modal" data-bs-target="#thankyou"><span class="">Submit</span></a>
                                            </div>
                                        </form>
                                    </div>
                                </div>
            ...
            <div class="modal-body">
                ...
                <div class=" mb-0 p-5">
                    ...
                    <div class="submit text-center mt-2">
                        <a href="institute-teacher-list.php" class=" btn btn-primary px-5 fs-6"><span class="">Okay</span></a>
                    </div>
                </div>
            </div>
        </div>
