        ...
        <div class="sticky">
            <div class="horizontal-header clearfix ">
                <div class="container">
                    ...
                    <span class="smllogo">
                        <a href="index.html">
                            <img src="assets/images/brand/hovee_attendance_1.svg" class="mobile-light-logo" width="120"
                                alt />
                            <img src="assets/images/brand/hovee_attendance_1.svg" class="mobile-dark-logo" width="120"
                                alt />
                        </a>
                    </span>
        ...
        <div class="horizontal-main bg-dark-transparent clearfix">
            <div class="horizontal-mainwrapper container clearfix">
                <div class="desktoplogo">
                    <a href="parent-dashboard.php"><img src="assets/images/brand/hovee_attendance_1.svg" alt></a>
                </div>
                ...
                <nav class="horizontalMenu clearfix d-md-flex">
                    <ul class="horizontalMenu-list">
                        <li aria-haspopup="true"><a href="#"><i class="fa fa-user-circle-o px-1"></i> My Account</a>
                            <ul class="sub-menu">
                            <li aria-haspopup="true"><a href="student-dashboard.php">My Dashboard</a></li>
                                <li aria-haspopup="true"><a href="student-edit-profile.php">View Profile</a></li>
                                <li aria-haspopup="true"><a href="student-payments.php">My Payments</a></li>
                                <li aria-haspopup="true"><a href="student-notifications.php">My Notifications</a>
                                </li>
                            </ul>
                        </li>
                        <li aria-haspopup="true"><a href="student-enqurireslist.php"><i class="fa fa-window-restore px-1" ></i>Enquiry List
                                </a></li>
                        <li aria-haspopup="true"><a href="student-enrollmentlist.php"><i class="fa fa-id-card-o px-1" ></i>Enrollments</a></li>
                        <li aria-haspopup="true"><a href="student-attendancelist.php"><i class="fa fa-book px-1" ></i>Attendance</a></li>
                        <li aria-haspopup="true"><a href="student-rating.php"><i class="fa fa-star px-1"></i>
                                Ratings</a>
                        </li>
                        <li aria-haspopup="true"><a href="student-subscription.php"><i class="fa fa-credit-card"></i>
                            </a></li>
                            ...
                            <div class="panel">
                                <div class="notification-panel" id="notificationPanel">
                                    ...
                                    <p class="text-end"><a href="student-notifications.php" class=" text-primary">See more</a></p>
                    ...
                    <ul class="mb-0">
                        <li aria-haspopup="true" class=" d-none d-lg-block top-postbtn">
                            <span><a class="btn bg-secondary px-5  rounded-pill text-white fw-bold" href="login.php">Log
                                    Out</a></span>
                        </li>
                    </ul>
                </nav>
