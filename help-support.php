		...
		<div class="panel-group1" id="accordion2">
			<div class="panel panel-default mb-4 p-0">
				<div class="panel-heading1 bg-light">
					<h4 class="panel-title1">
						<a class="accordion-toggle collapsed" data-bs-toggle="collapse" data-parent="#accordion2" href="#collapseone" aria-expanded="false">1. What the first step of the Class buying process? </a>
					</h4>
				</div>
			...
			<div class="panel panel-default mb-4 p-0">
				<div class="panel-heading1">
					<h4 class="panel-title1">
						<a class="accordion-toggle collapsed" data-bs-toggle="collapse" data-parent="#accordion2" href="#collapsetwo" aria-expanded="false">2. How long does it take to buy a Class? </a>
					</h4>
				</div>
			...
			<div class="panel panel-default mb-4 p-0">
				<div class="panel-heading1 bg-light">
					<h4 class="panel-title1">
						<a class="accordion-toggle collapsed" data-bs-toggle="collapse" data-parent="#accordion2" href="#collapsethree" aria-expanded="false">3. What is a seller's market?</a>
					</h4>
				</div>
			...
			<div class="panel panel-default mb-4 p-0">
				<div class="panel-heading1">
					<h4 class="panel-title1">
						<a class="accordion-toggle collapsed" data-bs-toggle="collapse" data-parent="#accordion2" href="#collapseFour" aria-expanded="false">4. What is a buyer's market?</a>
					</h4>
				</div>
			...
			<div class="panel panel-default mb-4 p-0">
				<div class="panel-heading1 bg-light">
					<h4 class="panel-title1">
						<a class="accordion-toggle collapsed" data-bs-toggle="collapse" data-parent="#accordion2" href="#collapseFive" aria-expanded="false">5. What is a stratified market?</a>
					</h4>
				</div>
			...
			<div class="panel panel-default mb-4 p-0">
				<div class="panel-heading1">
					<h4 class="panel-title1">
						<a class="accordion-toggle collapsed" data-bs-toggle="collapse" data-parent="#accordion2" href="#collapsesix" aria-expanded="false">6. How much do I have to pay an agent to help me buy a house?</a>
					</h4>
				</div>
			...
			<div class="panel panel-default p-0 mb-4">
				<div class="panel-heading1 bg-light">
					<h4 class="panel-title1">
						<a class="accordion-toggle collapsed" data-bs-toggle="collapse" data-parent="#accordion2" href="#collapseseven" aria-expanded="false">7. What kind of credit score do I need to buy a Class?</a>
					</h4>
				</div>
			...
			<div class="panel panel-default p-0">
				<div class="panel-heading1">
					<h4 class="panel-title1">
						<a class="accordion-toggle collapsed" data-bs-toggle="collapse" data-parent="#accordion2" href="#collapseight" aria-expanded="false">8. How much do I need for a down payment?</a>
					</h4>
				</div>
