        ...
        <div class="sticky">
            <div class="horizontal-header clearfix ">
                <div class="container">
                    ...
                    <span class="smllogo">
                        <a href="hostel-owner-dashboard.php">
        ...
        <div class="horizontal-main bg-dark-transparent clearfix">
            <div class="horizontal-mainwrapper container clearfix">
                <div class="desktoplogo">
                    <a href="hosteller-dash.php"><img src="assets/images/brand/hovee_attendance_1.svg" alt></a>
                </div>
                ...
                <nav class="horizontalMenu clearfix d-md-flex">
                    <ul class="horizontalMenu-list">
                        <li aria-haspopup="true"><a href="#" class=""><i class="fa fa-user-circle-o px-1"></i> My Account</a>
                            <ul class="sub-menu">
                                <li aria-haspopup="true"><a href="hosteller-dashboard.php">My Dashboard</a></li>
                                <li aria-haspopup="true"><a href="hosteller-editprofile.php">View Profile</a></li>
                                <li aria-haspopup="true"><a href="hostellerpayments.php">Payments</a></li>
                                <li aria-haspopup="true"><a href="hosteller-notification.php">Notifications</a>
                                </li>
                            </ul>
                        </li>
                        <li aria-haspopup="true"><a href="hostel-list.php"><i class="fa fa-th px-1"></i>Hostel List</a>
                        </li>
                        <li aria-haspopup="true"><a href="#"><i class="fa fa-id-card-o px-1"></i>Enrollments</a></li>
                        <li aria-haspopup="true"><a href="hosteller-attendlist.php"><i class="fa fa-book px-1"></i>Attendance</a></li>
                        <li aria-haspopup="true"><a href="hosteller-ratings.php"><i class="fa fa-star px-1"></i>
                                Ratings</a></li>
                        ...
                        <li aria-haspopup="true"><a href="#" class="icon-font-bell"> <i class=" icon icon-bell text-dark" id="bellIcon"></i><span class="badge badge-4 rounded-circle text-center">5</span></a>
                            ...
                            <div class="panel">
                                <div class="notification-panel" id="notificationPanel">
                                    ...
                                    <p class="text-end"><a href="hosteller-notification.php" class=" text-primary">See more</a></p>
