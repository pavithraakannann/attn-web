                ...
                <div class="container">
                    ...
                    <span class="smllogo">
                        <a href="index.html">
                            ...
                            <img src="assets/images/brand/hovee_attendance.svg" class="mobile-dark-logo" width="120" alt />
                        </a>
                    </span>
                ...
                <nav class="horizontalMenu clearfix d-md-flex">
                    <ul class="horizontalMenu-list">
                        <li aria-haspopup="true"><a href="#" class=""><i class="fa fa-user-circle-o px-1"></i> My
                                Account</a>
                            <ul class="sub-menu">
                                <li aria-haspopup="true"><a href="tutor-dashboard.php">My Dashboard</a></li>
                                <li aria-haspopup="true"><a href="tutor-edit-profile.php">View Profile</a></li>
                        ...
                        <li aria-haspopup="true"><a href="tutor-enquirylist.php" class=""><i class="fa fa-window-restore px-1"></i>
                                Enquries</a></li>
                        <li aria-haspopup="true"><a href="tutor-enrollmentlist.php"><i class="fa fa-id-card-o px-1"></i> Enrollments </a></li>
                    ...
                    <ul class="mb-0">
                        <li aria-haspopup="true" class=" d-none d-lg-block top-postbtn">
                            <span><a class="btn bg-secondary px-5  rounded-pill text-white fw-bold" href="index.php">Log Out</a></span>
                        </li>
                    </ul>
                </nav>
                <!--Nav-->
