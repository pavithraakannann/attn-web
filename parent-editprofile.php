            ...
            <div class="col-xl-9 col-lg-12 col-md-12">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="mb-3 ">
                            <div class="card">
                                <ul class="nav nav-tabs justify-content-center bg-primary py-1">
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link active pers-link text-white py-2 px-5 fs-6" id="tab-11-tab" data-bs-toggle="tab" href="#tab-11"
                                            role="tab" aria-controls="tab-11" aria-selected="true">Child 1 </a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link pers-link text-white py-2 px-5 fs-6" id="tab-12-tab" data-bs-toggle="tab" href="#tab-12"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="email" class="form-control py-5 ps "
                                                                placeholder="Enter your email" value="text@gmail.com">
                                                        </div>
                                                        <div class="col-md-6">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="phonenumber" class="form-control py-5 ps "
                                                                placeholder="Enter Phone number" value="8778591960">
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label class="form-label text-dark">Standard</label>
                                                            <input type="text" class="form-control py-5 ps "
                                                                placeholder="Enter your standard" value="12th">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
            ...
            <div class="modal-body">
                ...
                <div class=" mb-0 p-5">
                    ...
                    <div class="submit text-center mt-2">
                        <a href="parent-editprofile.php" class=" btn btn-secondary px-5 fs-6"><span
                                class="">Okay</span></a>
                    </div>
                </div>
