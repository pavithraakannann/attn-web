...
<section>
    <div class="banner-1 cover-image sptb-2 sptb-tab bg-background2 animation-zidex bg-white" data-bs-image-src="assets/images/banners/banner2.jpg">
        <div class="svg-home">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 250">
                <path fill="#fff" fill-opacity="1" d="M0,192L60,202.7C120,213,240,235,360,208C480,181,600,107,720,74.7C840,43,960,53,1080,74.7C1200,96,1320,128,1380,144L1440,160L1440,320L1380,320C1320,320,1200,320,1080,320C960,320,840,320,720,320C600,320,480,320,360,320C240,320,120,320,60,320L0,320Z">
                </path>
            </svg>
        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class=" mx-auto mb-0">
                                <img src="assets/images/photos/main-1.png" class="img-thumbnail-1 rounded-circle alt=" alt="">
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-3 col-md-6 mx-auto">
                                                <div class="team-img-2 text-center">
                                                    <img src="assets/images/media/3.png" class="img-thumbnail-3 bg-transparent" alt="">
                                                </div>
                                            </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex team-section-2">
                                        <div class="row">
                                            <div class="col-xl-3 col-md-6 mx-auto">
                                                <div class="team-img-2 text-center">
                                                    <img src="assets/images/media/2.png" class="img-thumbnail-3 bg-transparent" alt="">
                                                </div>
                                            </div>
                                            <div class="col-xl-9 col-sm-6">
                                ...
                                <div class="card-body">
                                    <div class="d-flex team-section-2 ">
                                        <div class="row">
                                            <div class="col-xl-3 col-md-6 mx-auto">
                                                <div class="team-img-2 text-center">
                                                    <img src="assets/images/media/1.png" class="img-thumbnail-3 bg-transparent" alt="">
                                                </div>
                                            </div>
                                            <div class="col-xl-9 col-sm-6">
                                                <div class="ms-lg-5 ms-xs-0 text-white card-day">
                ...
                <div class="row">
                        ...
                        <div class="card p-5 card-cat shadow-lg">
                            <a href="#" class="text-dark">
                                <h1 class="card-title mb-5 ">
                                    <img src="assets/images/faces/female/1.jpg" alt="img" class="w-8 h-8 br-3">
                                </h1>
                            </a>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card p-5 card-cat shadow-lg">
                            <a href="#" class="text-dark">
                                <h1 class="card-title mb-5 ">
                                    <img src="assets/images/faces/female/2.jpg" alt="img" class="w-8 h-8 br-3">
                                </h1>
                            </a>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card p-5 card-cat shadow-lg">
                            <a href="#" class="text-dark">
                                <h1 class="card-title mb-5 ">
                                    <img src="assets/images/faces/female/3.jpg" alt="img" class="w-8 h-8 br-3">
                                </h1>
                            </a>
                            ...
                            <div class="item-card-desc">
                                <div class="card text-center overflow-hidden">
                                    ...
                                    <div class="item-card-text">
                                        <h4 class="mb-0"><i class="fa fa-map-marker text-white me-1 fs-3"></i><span class="fs-3">Registeration</span></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="item-card overflow-hidden">
                            <div class="item-card-desc">
                                <div class="card text-center overflow-hidden">
                                    ...
                                    <div class="item-card-text">
                                        <h4 class="mb-0"><i class="fa fa-map-marker text-white me-1 fs-3"></i><span class="fs-3">Enrollments</span></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="item-card overflow-hidden">
                            <div class="item-card-desc">
                                <div class="card text-center overflow-hidden mb-lg-0">
                                    ...
                                    <div class="item-card-text">
                                        <h4 class="mb-0"><i class="fa fa-map-marker text-white me-1 fs-3"></i><span class="fs-3">Ratings</span></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="item-card overflow-hidden">
                            <div class="item-card-desc">
                                <div class="card text-center overflow-hidden mb-lg-0">
                                    ...
                                    <div class="item-card-text">
                                        <h4 class="mb-0"><i class="fa fa-map-marker text-white me-1 fs-3"></i><span class="fs-3">attendance</span></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="item-card overflow-hidden">
                    <div class="item-card-desc">
                        <div class="card overflow-hidden mb-0">
                            <div class="card-img">
                                <img src="assets/images/categories/student.jpg" alt="img" class="cover-image">
                            </div>
                            <div class="item-card-text">
                                <h4 class="mb-0"><i class="fa fa-map-marker text-white me-1 fs-3"></i><span class="fs-3">Search Using Map</span></h4>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xl-6 col-sm-8">
                        <div class="ms-lg-5 ms-xs-0 text-white card-day pt-5 mt-5 hovee-downloads">
                            ...
                            <div class="btn-list pt-3 ms-auto">
                                <img src="assets/images/categories/downloadapp.png" alt="googleplay" width="25" class="playstore">
                                <img src="assets/images/categories/goo.png" alt="googleplay" width="25" class="playstore mx-2">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row Download-img">
                            <div class="col-6">
                                <div class="team-img-2">
                                    <img src="assets/images/thumbnails/mobile-view-1.png" class="img-thumbnail-3 bg-transparent" alt="" width="200">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="team-img-2">
                                    <img src="assets/images/thumbnails/mobile-view-2.png" class="img-thumbnail-3 bg-transparent" alt="" width="200">
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-xl-8 col-md-12 d-block mx-auto ">
                                    <div class="testimonia">
                                        <div class="testimonia-img mx-auto mb-3">
                                            <img src="assets/images/faces/female/3.jpg" class="img-thumbnail rounded-circle alt=" alt="">
                                        </div>
                                        <p>
...
<div class="sticky-chat">
    ...
    <a class="chat-button" href="https://api.whatsapp.com/send?phone=9876565432" rel="nofollow noreferrer" target="_blank">
