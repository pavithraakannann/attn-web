                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="email" class="form-control py-5 ps "
                                                            placeholder="Enter your email" value="test@gmail.com">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="form-label text-dark">Date of birth</label>
                                                        <input type="date" class="form-control py-5 " value="24/09/2001">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="phonenumber" class="form-control py-5"
                                                        placeholder="your phone number" value="8778591960">
            ...
            <div class="modal-body">
                <div class=" mb-0 p-5">
                    ...
                    <div class="submit text-center mt-2">
                        <a href="institute-tutor-dash.php" class=" btn btn-secondary px-5 fs-6"><span
                                class="">Okay</span></a>
                    </div>
                </div>
            </div>
